...
namespace LDA
{
	class LDA
	{
		...
		static public LDA getInstance(List<int[]> On, int wordnum, int topicNum, double alpha, double beta, int seed)
		{
			return new LDA(On, wordnum, topicNum, alpha, beta, seed);
		}

		public LDA(List<int[]> On, int wordnum, int topicNum, double alpha, double beta, int seed)
		{
